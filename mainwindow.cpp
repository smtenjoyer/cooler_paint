...
MainWindow::MainWindow()
{
    ...
    createActions();
    createMenus();
    setWindowTitle(tr("coolre_paint"));
...
void MainWindow::penWidth(){
    bool ok;
    int newWidth = QInputDialog::getInt(this, tr("Doodle"),
                                        tr("Select pen width : "),
                                        doodleArea->penWidth(),
                                        1, 50, 1, &ok);
    if(ok){
        doodleArea->setPenWidth(newWidth);
    }
}

void MainWindow::about(){
    QMessageBox::about(this, tr("About cooler_paint"),
